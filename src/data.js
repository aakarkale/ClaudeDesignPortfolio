...
export const AK_DATA = {
  ...
  experience: [
    {
      ...
      bullets: [
        ...
        { text: 'Worked closely with the CEO and leadership team to align product strategy, negotiate vendor contracts, translate engineering context into clear timelines, and drive commercial launch readiness for DealerCloud.', link: { label: 'DealerCloud', href: 'https://www.dealercloud.com/' } },
        { text: 'Over the last few years at DGDG I’ve built and expanded DGDGDash, the internal ops backbone and analytics layer across 18 rooftops, surfacing inventory, sales, service and finance performance in real time, cutting manual reporting hours by 40% and giving teams and leadership one shared source of truth.', link: { label: 'DGDGDash', href: 'https://dgdgdash.com/' } },
      ],
    },
    {
  ...
  projects: [
    ...
    },
    {
      ...
      index: '08',
      title: 'Been',
      oneLiner: 'Drop notes and reminders on the places that matter, then get gently nudged when you’re nearby.',
      tags: ['Maps', 'Geofencing', 'Mobile'],
